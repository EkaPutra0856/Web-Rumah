    ...
    <div id="editModal{{ $p->id }}"
        ...
        <div class="bg-gray-800 rounded-lg w-1/2">
            <form method="POST" action="{{ url('/' . $p->id . '/update-kk') }}" class=" w-5/6 mx-auto my-5">
                ...
                <div class="basis-1/2 mb-5">
                    <label for="namakk" class="block mb-2 text-sm font-medium  text-white">Nama Kepala
                        Keluarga</label>
                ...
                <div class="basis-1/2 mb-5">
                    <label for="anggota" class="block mb-2 text-sm font-medium  text-white">Jumlah Anggota
                        Keluarga</label>
