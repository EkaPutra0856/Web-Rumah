        ...
        <form method="POST" action="{{ url('/' . $p->id . '/update-rumah') }}" class="w-5/6 mx-auto my-5">
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/2 p-2">
                    <label for="wilayah_id" class="block mb-2 text-sm font-medium text-white">ID Wilayah</label>
                    <input name="wilayah_id" type="text" id="wilayah_id" class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" value="{{ $p->wilayah_id }}" readonly>
                </div>
                <div class="w-full md:w-1/2 p-2">
