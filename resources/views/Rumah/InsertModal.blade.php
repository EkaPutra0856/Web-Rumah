    ...
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="insert-kk" class="w-5/6 mx-auto my-5">
            ...
            <div class="basis-1/2 mb-5">
                <label for="rumah_id" class="block mb-2 text-sm font-medium text-white">NO ID Rumah</label>
            ...
            <div class="basis-1/2 mb-5">
                ...
                <input name="norumah" type="number" id="norumah"
                    class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="alamat" class="block mb-2 text-sm font-medium text-white">Alamat</label>
                <input name="alamat" type="number" id="alamat"
                    class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="wilayah_id" class="block mb-2 text-sm font-medium text-white">Alamat</label>
                <input name="wilayah_id" type="number" id="wilayah_id"
                    class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
            </div>
